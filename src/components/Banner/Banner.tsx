...
export default function Banner({id, img, botname, description}: Props) {
  ...
  return (
    <Link to={`/chat/${botname}`} className='min-h-36 p-4 bg-[var(--bgElements)] rounded-md flex hover:bg-[#414142] duration-300 cursor-pointer z-1 cursor-pointer' onClick={() => handleClick()}>
