...
export default function LittleBanner({id, img, botname, description}: Props) {
  ...
  return (
    <Link to={`/chat/${botname}`} className='w-[312px] h-[78px] p-3 gap-2 bg-[var(--bgElements)] rounded-md mx-1 mt-4 hover:bg-[#414142] duration-300 sm:min-w-[312px] cursor-pointer' onClick={() => handleClick()}>
